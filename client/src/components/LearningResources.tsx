...
function buildResources(skills: string[], university?: UniversityOption): Resource[] {
  // Build the library from every skill in the CURRENT roadmap stage instead of
  // using only the first skill. This prevents the same six links appearing on
  // unrelated stages that happen to start with a common skill.
