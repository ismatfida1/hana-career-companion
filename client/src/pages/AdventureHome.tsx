...
const worlds = [
  ...
  ["Webwilds", "/assets/worlds/webwilds.svg", "Make things people use", "/projects"],
  ["Skyforge", "/assets/worlds/skyforge.svg", "Ship real projects", "/projects"],
  ["Beacon Summit", "/assets/worlds/beacon-summit.svg", "Find your next opportunity", "/opportunities"],
] as const;
const menu = [
