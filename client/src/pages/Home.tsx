...
const roadmapStages = [
  { number: "01", world: "The Verdant Gate", title: "Programming foundations", subtitle: "Build your base", state: "current", nodes: ["Python fundamentals", "Git & GitHub", "Problem solving"] },
  { number: "02", world: "The Clockwork Archives", title: "Core computer science", subtitle: "Think like an engineer", state: "next", nodes: ["Data structures", "Algorithms", "Databases", "Networking"] },
  { number: "03", world: "The Webwilds", title: "Build for the web", subtitle: "Turn ideas into products", state: "locked", nodes: ["Frontend", "Backend", "REST APIs", "Authentication"] },
  { number: "04", world: "The Skyforge", title: "Professional engineering", subtitle: "Ship with confidence", state: "locked", nodes: ["Testing", "System design", "Deployment", "Cloud"] },
  { number: "05", world: "The Beacon Summit", title: "Career launch", subtitle: "Make your work visible", state: "locked", nodes: ["Portfolio", "Open source", "Interview prep"] },
];
